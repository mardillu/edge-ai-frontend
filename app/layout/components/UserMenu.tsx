...
import { Brightness4, Logout, Settings, QuestionMark } from "@mui/icons-material";
import {
  Link,
  ListItemIcon,
  ListItemText,
...
export function UserMenu(props: UserMenuProps): React.JSX.Element {
  ...
  return (
    ...
    >
      ...
      <MenuItem component={NavLink} to="/about" onClick={close}>
        <ListItemIcon sx={{ minWidth: 40 }} children={<QuestionMark />} />
        <ListItemText primary="About Edge AI" />
      </MenuItem>
